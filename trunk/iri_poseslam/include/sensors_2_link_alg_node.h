...
class Sensors2LinkAlgNode : public algorithm_base::IriBaseAlgorithm<Sensors2LinkAlgorithm>
{
  private:
    ...
    // State booleans
    bool new_laser_scan_, fusion_ready_;
    uint ready_odom_id_, prev_seq;
    // Accumulated relative odometry
    Vector3d odom_rel_, d_local;
    Matrix3d odom_rel_cov_, Jp, Jd, Q;
    ...
    bool online_mode, stopped_since_last_odom, currently_stopped;
  ...
  protected:
    ...
    * \param prior_d the vector containing the prior estimation for ICP in base footprint frame
    */
