...
#ifndef _obstacle_detection_alg_h_
#define _obstacle_detection_alg_h_
...
#include <iri_obstacle_detection/ObstacleDetectionConfig.h>
#include <sensor_msgs/PointCloud2.h>
#include "mutex.h"

//include obstacle_detection_alg main library
...
class ObstacleDetectionAlgorithm
{
  protected:
    ...
    *
    * Define a Config type with the ObstacleDetectionConfig. All driver implementations
  ...
  public:
    ...
    */
    ...
    // here define all obstacle_detection_alg interface methods to retrieve and set
