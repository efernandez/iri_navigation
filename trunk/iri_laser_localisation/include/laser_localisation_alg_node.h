...
#ifndef _laser_localisation_alg_node_h_
#define _laser_localisation_alg_node_h_
 ...
 *
 */
class LaserLocalisationAlgNode : public algorithm_base::IriBaseAlgorithm<LaserLocalisationAlgorithm>
{
  private:
    ...
    void calc_T_mapa_odom_(sensor_msgs::LaserScan const& scan_ref,
